...
parser.add_argument('--pretrain_path', default='C:/Users/GorNaKat/AppData/Local/Programs/Python/Python310/Lib/site-packages/opennre/pretrain/la-bse-en-ru', 
...
sentence_encoder = opennre.encoder.LaBSEenru(
...
# Define the model
for child in sentence_encoder.children():
